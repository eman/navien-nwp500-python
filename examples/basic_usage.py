    ...
    try:
        ...
        if args.email and args.password:
            ...
            if config.email and config.password:
                ...
                logger.error("  1. Copy .env.template to .env and fill in your credentials")
                logger.error("  2. Set NAVILINK_EMAIL and NAVILINK_PASSWORD environment variables")
            ...
            for i, device in enumerate(devices):
                ...
                try:
                    ...
                    if status:
                        ...
                        logger.info(f"   Target Temperature: {status.dhw_temperature_setting}°F")
                ...
                try:
                    ...
                    if connectivity:
                        ...
                        logger.info(f"   Device Connected: {'✅ Yes' if connected else '❌ No'}")
                        if not connected:
                            logger.warning("   ⚠️ Device offline - MQTT monitoring not available")
                    else:
