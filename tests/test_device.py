...
class TestNaviLinkDevice:
    ...
    async def test_get_connectivity_status(self, mock_device):
        ...
        mock_response.json.return_value = {
            "result": "success",
            "data": {"device_connected": 1, "last_seen": "2024-01-01T12:00:00Z"},
        }

        mock_device.client._session.get.return_value.__aenter__.return_value = (
            mock_response
        )
    ...
    async def test_get_device_info(self, mock_device):
        ...
        mock_device.client._session.post.return_value.__aenter__.return_value = (
            mock_response
        )
